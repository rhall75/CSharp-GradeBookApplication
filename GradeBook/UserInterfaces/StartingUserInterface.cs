...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (String.Compare(parts[2], "standard", true ) == 0)
            {
                gradeBook = new StandardGradeBook(name, Boolean.Parse(parts[3]));
            }
            else if (String.Compare(parts[2], "ranked", true) == 0)
            {
                gradeBook = new RankedGradeBook(name, Boolean.Parse(parts[3]));
            }
            else
            {
